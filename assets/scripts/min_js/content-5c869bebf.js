...
(function (r) {
    r.fn.qrcode = function (h) {
        var s;function u(a) {
            ...
            if (void 0 == a.length) throw Error(a.length + "/" + c);for (var d = 0; d < a.length && 0 == a[d];) d++;this.num = Array(a.length - d + c);for (var b = 0; b < a.length - d; b++) this.num[b] = a[b + d];
        }function p(a, c) {
            ...
            write: function (a) {
                ...
                this.moduleCount = 4 * this.typeNumber + 17;this.modules = Array(this.moduleCount);for (var d = 0; d < this.moduleCount; d++) {
                    this.modules[d] = Array(this.moduleCount);for (var b = 0; b < this.moduleCount; b++) this.modules[d][b] = null;
                ...
                a = a.createEmptyMovieClip(c, d);this.make();for (c = 0; c < this.modules.length; c++) for (var d = 1 * c, b = 0; b < this.modules[c].length; b++) {
                    var e = 1 * b;this.modules[c][b] && (a.beginFill(0, 100), a.moveTo(e, d), a.lineTo(e + 1, d), a.lineTo(e + 1, d + 1), a.lineTo(e, d + 1), a.endFill());
                }return a;
            },
            setupTimingPattern: function () {
                for (var a = 8; a < this.moduleCount - 8; a++) null == this.modules[a][6] && (this.modules[a][6] = 0 == a % 2);for (a = 8; a < this.moduleCount - 8; a++) null == this.modules[6][a] && (this.modules[6][a] = 0 == a % 2);
            }, setupPositionAdjustPattern: function () {
                for (var a = j.getPatternPosition(this.typeNumber), c = 0; c < a.length; c++) for (var d = 0; d < a.length; d++) {
                    var b = a[c],
                        e = a[d];if (null == this.modules[b][e]) for (var f = -2; 2 >= f; f++) for (var i = -2; 2 >= i; i++) this.modules[b + f][e + i] = -2 == f || 2 == f || -2 == i || 2 == i || 0 == f && 0 == i ? !0 : !1;
                }
                ...
                }for (b = 0; 15 > b; b++) e = !a && 1 == (d >> b & 1), 8 > b ? this.modules[8][this.moduleCount - b - 1] = e : 9 > b ? this.modules[8][15 - b - 1 + 1] = e : this.modules[8][15 - b - 1] = e;this.modules[this.moduleCount - 8][8] = !a;
            ...
            }for (e = a = 0; e < c.length; e++) a += c[e].dataCount;if (b.getLengthInBits() > 8 * a) throw Error("code length overflow. (" + b.getLengthInBits() + ">" + 8 * a + ")");for (b.getLengthInBits() + 4 <= 8 * a && b.put(0, 4); 0 != b.getLengthInBits() % 8;) b.putBit(!1);for (; !(b.getLengthInBits() >= 8 * a);) {
            ...
            for (var d = 0, b = 0, e = 0, f = Array(c.length), i = Array(c.length), g = 0; g < c.length; g++) {
                var n = c[g].dataCount,
                    h = c[g].totalCount - n,
                    b = Math.max(b, n),
                    e = Math.max(e, h);f[g] = Array(n);for (var k = 0; k < f[g].length; k++) f[g][k] = 255 & a.buffer[k + d];d += n;k = j.getErrorCorrectPolynomial(h);n = new q(f[g], k.getLength() - 1).mod(k);i[g] = Array(k.getLength() - 1);for (k = 0; k < i[g].length; k++) h = k + n.getLength() - i[g].length, i[g][k] = 0 <= h ? n.get(h) : 0;
                ...
                for (var c = a << 10; 0 <= j.getBCHDigit(c) - j.getBCHDigit(j.G15);) c ^= j.G15 << j.getBCHDigit(c) - j.getBCHDigit(j.G15);return (a << 10 | c) ^ j.G15_MASK;
            }, getBCHTypeNumber: function (a) {
                for (var c = a << 12; 0 <= j.getBCHDigit(c) - j.getBCHDigit(j.G18);) c ^= j.G18 << j.getBCHDigit(c) - j.getBCHDigit(j.G18);return a << 12 | c;
            }, getBCHDigit: function (a) {
                for (var c = 0; 0 != a;) c++, a >>>= 1;return c;
                ...
                for (var c = new q([1], 0), d = 0; d < a; d++) c = c.multiply(new q([1, l.gexp(d)], 0));return c;
                ...
                for (var c = a.getModuleCount(), d = 0, b = 0; b < c; b++) for (var e = 0; e < c; e++) {
                    for (var f = 0, i = a.isDark(b, e), g = -1; 1 >= g; g++) if (!(0 > b + g || c <= b + g)) for (var h = -1; 1 >= h; h++) 0 > e + h || c <= e + h || 0 == g && 0 == h || i == a.isDark(b + g, e + h) && f++;5 < f && (d += 3 + f - 5);
                }for (b = 0; b < c - 1; b++) for (e = 0; e < c - 1; e++) if (f = 0, a.isDark(b, e) && f++, a.isDark(b + 1, e) && f++, a.isDark(b, e + 1) && f++, a.isDark(b + 1, e + 1) && f++, 0 == f || 4 == f) d += 3;for (b = 0; b < c; b++) for (e = 0; e < c - 6; e++) a.isDark(b, e) && !a.isDark(b, e + 1) && a.isDark(b, e + 2) && a.isDark(b, e + 3) && a.isDark(b, e + 4) && !a.isDark(b, e + 5) && a.isDark(b, e + 6) && (d += 40);for (e = 0; e < c; e++) for (b = 0; b < c - 6; b++) a.isDark(b, e) && !a.isDark(b + 1, e) && a.isDark(b + 2, e) && a.isDark(b + 3, e) && a.isDark(b + 4, e) && !a.isDark(b + 5, e) && a.isDark(b + 6, e) && (d += 40);for (e = f = 0; e < c; e++) for (b = 0; b < c; b++) a.isDark(b, e) && f++;a = Math.abs(100 * f / c / c - 50) / 5;return d + 10 * a;
            } }, l = { glog: function (a) {
                if (1 > a) throw Error("glog(" + a + ")");return l.LOG_TABLE[a];
            }, gexp: function (a) {
                for (; 0 > a;) a += 255;for (; 256 <= a;) a -= 255;return l.EXP_TABLE[a];
            }, EXP_TABLE: Array(256),
            LOG_TABLE: Array(256) }, m = 0; 8 > m; m++) l.EXP_TABLE[m] = 1 << m;for (m = 8; 256 > m; m++) l.EXP_TABLE[m] = l.EXP_TABLE[m - 4] ^ l.EXP_TABLE[m - 5] ^ l.EXP_TABLE[m - 6] ^ l.EXP_TABLE[m - 8];for (m = 0; 255 > m; m++) l.LOG_TABLE[l.EXP_TABLE[m]] = m;q.prototype = { get: function (a) {
                return this.num[a];
            }, getLength: function () {
                return this.num.length;
            }, multiply: function (a) {
                for (var c = Array(this.getLength() + a.getLength() - 1), d = 0; d < this.getLength(); d++) for (var b = 0; b < a.getLength(); b++) c[d + b] ^= l.gexp(l.glog(this.get(d)) + l.glog(a.get(b)));return new q(c, 0);
            }, mod: function (a) {
                if (0 > this.getLength() - a.getLength()) return this;for (var c = l.glog(this.get(0)) - l.glog(a.get(0)), d = Array(this.getLength()), b = 0; b < this.getLength(); b++) d[b] = this.get(b);for (b = 0; b < a.getLength(); b++) d[b] ^= l.gexp(l.glog(a.get(b)) + c);return new q(d, 0).mod(a);
            ...
            var d = p.getRsBlockTable(a, c);if (void 0 == d) throw Error("bad rs block @ typeNumber:" + a + "/errorCorrectLevel:" + c);for (var b = d.length / 3, e = [], f = 0; f < b; f++) for (var h = d[3 * f + 0], g = d[3 * f + 1], j = d[3 * f + 2], l = 0; l < h; l++) e.push(new p(g, j));return e;
            ...
            var a;if ("canvas" == h.render) {
                ...
                a = new o(h.typeNumber, h.correctLevel);a.addData(h.text);a.make();c = r("<table></table>").css("width", h.width + "px").css("height", h.height + "px").css("border", "0px").css("border-collapse", "collapse").css("background-color", h.background);d = h.width / a.getModuleCount();b = h.height / a.getModuleCount();for (e = 0; e < a.getModuleCount(); e++) {
                    f = r("<tr></tr>").css("height", b + "px").appendTo(c);for (i = 0; i < a.getModuleCount(); i++) r("<td></td>").css("width", d + "px").css("background-color", a.isDark(e, i) ? h.foreground : h.background).appendTo(f);
                }
...
$(function () {
    ...
    // 相关专题点击切换效果
    var $bannerTopic = $('.banner-topic-wrapper'),
        $tagsWrapper = $('#tags-wrapper');
    $tagsWrapper.children().eq(0).addClass('active');
    $bannerTopic.eq(0).addClass('active');

    $tagsWrapper.click(function (e) {
        var _index = $(e.target).index();
        __commonToggleActive([$(e.target), $bannerTopic.eq(_index)]);
    });
    ...
    function loadComments(data) {
        var __commentItem = commentItemTemplate.replace('{{ id }}', data['id']).replace('{{ nickname }}', data['nickname']).replace('{{ ip_address }}', data['ip_address']).replace('{{ add_time }}', function () {
            return formatDate(data['add_time'] * 1000);
        }).replace('{{ content }}', data['content']).replace('{{ like }}', data['like']).replace('{{ unlike }}', data['unlike']);
        ...
        if (data['parent']) {
            ...
            $.each(data['parent'], function (index, element) {
                ...
                if (index === 0) {
                    __replyBox = replyBoxTemplate.replace('{{ id }}', element['id']).replace('{{ nickname }}', element['nickname']).replace('{{ ip_address }}', data['ip_address']).replace('{{ add_time }}', function () {
                        return formatDate(element['add_time'] * 1000);
                    }).replace('{{ content }}', element['content']).replace('{{ like }}', element['like']).replace('{{ unlike }}', element['unlike']);
                } else if (index > 0) {
                    __replyBox = __replyBox.replace('{{ moreReplyBoxPlaceHolder }}', function () {
                        return replyBoxTemplate.replace('{{ id }}', element['id']).replace('{{ nickname }}', element['nickname']).replace('{{ ip_address }}', data['ip_address']).replace('{{ add_time }}', function () {
                            return formatDate(element['add_time'] * 1000);
                        }).replace('{{ content }}', element['content']).replace('{{ like }}', element['like']).replace('{{ unlike }}', element['unlike']);
                    });
                }
    ...
    function getReplyDiv() {
        if (replyDiv) {
            ...
            var $divWrapper = $('<div class="reply-text-wrapper">'),
                $emojiDiv = $('<div class="emoji-wrapper" id="reply-emoji-wrapper"><span class="icon-emoji" id="reply-icon-emoji"></span><div class="emojis" id="reply-emojis"><img src="/assets/emotion/01.gif" title="[s:爱心]"><img src="/assets/emotion/02.gif" title="[s:汗]"><img src="/assets/emotion/03.gif" title="[s:黑]"><img src="/assets/emotion/04.gif" title="[s:加班]"><img src="/assets/emotion/05.gif" title="[s:贱笑]"><img src="/assets/emotion/06.gif" title="[s:惊讶]"><img src="/assets/emotion/07.gif" title="[s:抠鼻]"><img src="/assets/emotion/08.gif" title="[s:哭]"><img src="/assets/emotion/09.gif" title="[s:喷]"><img src="/assets/emotion/10.gif" title="[s:沙发]"><img src="/assets/emotion/11.gif" title="[s:生气]"><img src="/assets/emotion/12.gif" title="[s:双负五]"><img src="/assets/emotion/13.gif" title="[s:笑]"><img src="/assets/emotion/14.gif" title="[s:晕]"></div></div>'),
...
$(function () {
    var $tab = $('.tab', '#tabs'),
        $tabView = $('.tab-view'),
        tabsNavArray = [];
    __commonToggleActive([$('#t-filters span').eq(0), $('#t-filters').next('.view').children('.toggled-view').eq(0)]);
    ...
    if (download_addr[1].length == 0) {
        ...
        var downStr = '<p class="title common_ovh">{ title }</p>' + '<p>高速下载器通道</p>' + '<ul>' + '<li>' + '<a href="' + down_link + '"><i class="icon-download"></i><span>电信高速下载</span></a>' + '</li>' + '<li>' + '<a href="' + down_link + '"><i class="icon-download"></i><span>网通高速下载</span></a>' + '</li>' + '<li>' + '<a href="' + down_link + '"><i class="icon-download"></i><span>迅雷高速下载</span></a>' + '</li>' + '<li>' + '<a href="' + down_link + '"><i class="icon-download"></i><span>快车高速下载</span></a>' + '</li>' + '</ul>' + '<p>其他下载地址</p>' + '<ul>' + '{ address }' + '</ul>';

        function subHtml(el, address) {
            var html = downStr.replace('{ title }', el.down_title).replace('{ address }', address);
            return html;
        }
