...
$(function () {
    ...
    var $contentH3 = $('#c1 .intro').length > 0 ? $('#c1 .intro') : $('#c1 h3'),
        $imgs = $('#c1 img'),
        $contentNav = $('#content-nav'),
        tabsBase = $('#p1').offset().top,
        heightArr = [];
    ...
    $(window).on('load scroll', function() {
        ...
        winTop > tabsBase ? $contentNav.show() : $contentNav.hide();
        if ($contentH3.length > 0) {
...
$(function() {
    ...
    function createPromptBox () {
        ...
        var $p_1 = $('<p class="lines">').text('安装软件提示文件损坏怎么处理？打开dmg文件提示损坏怎么处理？来自不信任的开发者怎么处理？'),
            ...
            $p_2 = $('<p class="lines">').text('VIP会员联系客服QQ：66559707');
